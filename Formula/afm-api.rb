class AfmApi < Formula
  ...
  url "https://github.com/tankibaj/apple-foundation-model-api/releases/download/v1.2.6/afm-api-macos-arm64.tar.gz"
  version "1.2.6"
  sha256 "9519f7d6a88a20877752b2cfb394cd2a0d39b034cc3b614c8e3d698d80d74d43"
  license "MIT"
